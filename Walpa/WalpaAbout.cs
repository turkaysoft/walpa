...
namespace Walpa{
    public partial class WalpaAbout : Form{
        public WalpaAbout(){
            InitializeComponent();
            //
        ...
        // ABOUT LOAD
        // ======================================================================================================
        private async void WalpaAbout_Load(object sender, EventArgs e){
            try{
        ...
        public void About_Preloader(){
            try{
                ...
                //
                BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_BGColor2");
                PanelTxt.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_BGColor2");
                //
                LabelDeveloper.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_LabelColor1");
                LabelSoftware.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                LabelVersion.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_LabelColor2");
                LabelCopyright.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_LabelColor2");
                //
                foreach (Control ui_buttons in PanelTxt.Controls){
                    if (ui_buttons is Button about_button){
                        about_button.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "DynamicThemeActiveBtnBGColor");
                        about_button.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                        about_button.FlatAppearance.BorderColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                        about_button.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                        about_button.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "AccentColorHover");
                    }
                }
                //
                TSImageRenderer(About_WebsiteBtn, WalpaMain.theme == 1 ? Properties.Resources.ct_website_light : Properties.Resources.ct_website_dark, 18, ContentAlignment.MiddleRight);
                TSImageRenderer(About_GitHubBtn, WalpaMain.theme == 1 ? Properties.Resources.ct_github_light : Properties.Resources.ct_github_dark, 18, ContentAlignment.MiddleRight);
                TSImageRenderer(About_DonateBtn, WalpaMain.theme == 1 ? Properties.Resources.tm_donate_mc_light : Properties.Resources.tm_donate_mc_dark, 18, ContentAlignment.MiddleRight);
                //
                AboutTable.BackgroundColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_BGColor2");
                AboutTable.GridColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "DataGridGridColor");
                AboutTable.DefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_BGColor2");
                AboutTable.DefaultCellStyle.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_LabelColor1");
                AboutTable.AlternatingRowsDefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_BGColor");
                AboutTable.ColumnHeadersDefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                AboutTable.ColumnHeadersDefaultCellStyle.SelectionBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                AboutTable.ColumnHeadersDefaultCellStyle.ForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "DynamicThemeActiveBtnBGColor");
                AboutTable.DefaultCellStyle.SelectionBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_AccentColor");
                AboutTable.DefaultCellStyle.SelectionForeColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "DynamicThemeActiveBtnBGColor");
                //
                CloseAboutBtn.BackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_CloseBG");
                CloseAboutBtn.FlatAppearance.BorderColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_CloseBG");
                CloseAboutBtn.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_CloseBGHover");
                CloseAboutBtn.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(WalpaMain.theme, "TSBT_CloseBGHover");
                // ======================================================================================================
                // TEXTS
