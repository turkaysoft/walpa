...
namespace Walpa{
    internal class TSModules{
        ...
        public class TS_LinkSystem{
            public const string
            // Main Control Links
            github_link_lv      = "https://raw.githubusercontent.com/turkaysoft/walpa/main/Walpa/SoftwareVersion.txt",
            github_link_lr      = "https://github.com/turkaysoft/walpa/releases/latest",
            // Social Links
        ...
        // READ LANG PATHS
        // ======================================================================================================
        public static readonly string ts_lf = Path.Combine(StartupPath, "w_langs");     // Main Path
